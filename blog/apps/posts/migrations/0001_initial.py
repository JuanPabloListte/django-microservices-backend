# Generated by Django 3.2.16 on 2024-04-12 13:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts_view_count', to='posts.post')),
            ],
        ),
        migrations.CreateModel(
            name='Rate',
        ...
        migrations.AddField(
            model_name='post',
            name='rating',
            field=models.ManyToManyField(related_name='postsRating', to='posts.Rate'),
        ),
        migrations.AddField(
            model_name='post',
            name='sub_category',
